...
if ($ConnectionMYSQL) {
    $SelectTicketsSQL10 = "SELECT * FROM TicketStatusView WHERE ID_User = ".$_SESSION['Id_User']." AND TicketStatus IN ('Open')";
                                ...
                                <tbody>
                                    <?php while ($InfoTickets10 = $Tickets10->fetch_object()) { ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <a class="like" href="CommentOpen.php?id=<?php echo $InfoTickets10->ID_Ticket; ?>" title="coment">
