                    ...
                    <div class="col-md-6">
                        <legend>
                            ...
                            <div class="col-md-12 centered-button">
                                <fieldset class="form-group">
                                    <button type="submit" class="btn btn-success centered-button" style="width: 220px; font-size:17px; ;">Save <i class="fa-solid fa-floppy-disk"></i></button>
                                </fieldset>
                            </div>
                        </legend>
                ...
                <?php while ($Info = $User_Info->fetch_object()) { ?>
                    <tr id="">
                        ...
                        <td style="white-space: nowrap; width: 1%;">
                            <div class="btn-group btn-group-sm" style="float: none;"><button type="button" class="tabledit-edit-button btn btn-sm btn-default btn-default" style="float: none;"><span class="glyphicon glyphicon-pencil"></span></button><button type="button" class="tabledit-delete-button btn btn-sm btn-default btn-danger" style="float: none;"><span class="glyphicon glyphicon-trash"></span></button></div>
