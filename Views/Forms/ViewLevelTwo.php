...
if ($ConnectionMYSQL) {
    $SelectTicketsSQL10 = "SELECT * FROM TicketStatusView WHERE ID_Difficulty = 2 AND TicketStatus IN ('Open', 'In Progress')";
                                ...
                                <tbody>
                                    <?php while ($InfoTickets10 = $Tickets10->fetch_object()) { ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <a class="like" href="EditTicketTwo.php?id=<?php echo $InfoTickets10->ID_Ticket; ?>">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                <a class="like" href="CommentTicketLevelTwo.php?id=<?php echo $InfoTickets10->ID_Ticket; ?>" title="coment">
